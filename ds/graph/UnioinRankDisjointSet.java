...
public class UnioinRankDisjointSet
{
	int V, E;
	Edge[] edge;

	UnioinRankDisjointSet(int nV, int nE)
	{
		V = nV;
		E = nE;
		edge = new Edge[E];
	...
	int isCycle(UnioinRankDisjointSet graph)
	{
		int V = graph.V;
		int E = graph.E;
	...
	public static void main(String[] args)
	{
		...
		int V = 3, E = 3;
		UnioinRankDisjointSet graph = new UnioinRankDisjointSet(V, E);
